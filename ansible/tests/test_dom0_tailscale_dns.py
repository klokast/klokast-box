...
class Dom0TailscaleDnsTest(unittest.TestCase):
    def test_dom0_tailscale_repairs_tailnet_dns(self):
        ...
        self.assertIn("Schedule Tailscale restart after package changes", text)
        self.assertIn("Wait for dom0 after Tailscale package-change restart", text)
        ...
        self.assertIn("dom0_tailscale_packages.changed", text)
        ...
        self.assertIn("Schedule Tailscale restart when daemon version lags the CLI", text)
