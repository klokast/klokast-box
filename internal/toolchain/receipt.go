...
const KindV8 = "klokast.controller-toolchain.v8"
...
func Validate(receipt Receipt, engineCommit string) error {
	if !((receipt.SchemaVersion == 8 && receipt.Kind == KindV8) || (receipt.SchemaVersion == 7 && receipt.Kind == KindV7) || (receipt.SchemaVersion == 6 && receipt.Kind == Kind) || (receipt.SchemaVersion == 5 && receipt.Kind == KindV5) || (receipt.SchemaVersion == 4 && receipt.Kind == KindV4) || (receipt.SchemaVersion == 3 && receipt.Kind == KindV3)) || !receipt.PublicCheckoutClean || receipt.EngineCommit != engineCommit || receipt.PublicCheckoutCommit != engineCommit {
