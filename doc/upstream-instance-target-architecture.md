...
| Instance-only routine operation | `implemented` | Engine `1b08129` and Toolchain v7 are installed. Unsigned verification stops on two stale live policy comments; signed acceptance remains pending. Section 11.7 owns the gates; [the runbook](../klokast-dev/runbooks/53-instance-only-verification.md#installed-preparation-2026-09-09) records preparation evidence. |
