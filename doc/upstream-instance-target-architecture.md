...
| Instance-only routine operation | `implemented` | Engine `1b08129` and Toolchain v7 are installed. The human-authorized comment repair and unsigned verification passed on 2026-09-11; signed acceptance remains pending. Section 11.7 owns the gates; [the runbook](../klokast-dev/runbooks/53-instance-only-verification.md#authorized-repair-2026-09-11) records preparation evidence. |
